    ...
    const String& frameName, const WindowFeatures& windowFeatures, JSValue* dialogArgs)
{
	...
	// Note by Arpit Baldeva: Due to the "FIXME" problem noted above, we send down the url information by attaching it to the WindowFeatures structure.
...
JSValue* windowProtoFuncOpen(ExecState* exec, JSObject*, JSValue* thisValue, const ArgList& args)
{
    ...
    windowFeatures.mURLToOpen = urlString;
