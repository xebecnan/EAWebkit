...
#error This file should not be compiled in the EAWebKit build. The BCXMLTokenizer.h version in our BAL directory should be used instead. -- Paul Pedriana, December 2008.
